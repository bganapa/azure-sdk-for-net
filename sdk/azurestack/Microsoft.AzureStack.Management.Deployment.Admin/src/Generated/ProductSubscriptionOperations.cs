...
namespace Microsoft.AzureStack.Management.Deployment.Admin
{
    ...
    /// </summary>
    internal partial class ProductSubscriptionOperations : IServiceOperations<DeploymentAdminClient>, IProductSubscriptionOperations
    {
        /// <summary>
        /// Initializes a new instance of the ProductSubscriptionOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ProductSubscriptionOperations(DeploymentAdminClient client)
        {
            if (client == null)
            {
